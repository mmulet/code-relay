  ...
  component: () => (
    <div className="terms-page-margin">
      ...
      <p>
        ...
        <a href="https://coderelay.io">https://coderelay.io</a>, you are agreeing
      ...
      <ol type="a">
        <li>
          ...
          (information or software) on Late for Dinner Studios, LLC's website for
          personal, transitory viewing only. This is the grant of a license, not a
          transfer of title, and under this license you may not:
          <ol type="i">
            <li>modify or copy the materials;</li>
            <li>
              attempt to decompile or reverse engineer any software contained on
              Late for Dinner Studios, LLC's website;
            </li>
            <li>
        ...
        <li>
          ...
          restrictions and may be terminated by Late for Dinner Studios, LLC at
          any time. Late for Dinner Studios, LLC may disallow your access to
          https://coderelay.io if you violate any of these restrictions or if Late
          for Dinner Studios, LLC is investigating any suspected violation. Upon
      ...
      <ol type="a">
        <li>
          The materials on Late for Dinner Studios, LLC's website are provided on
          an 'as is' basis. Late for Dinner Studios, LLC makes no warranties,
      ...
      <h3>4. Limitations</h3>
      <p>
        In no event shall Late for Dinner Studios, LLC or its suppliers be liable
        ...
        inability to use the materials on Late for Dinner Studios, LLC's website,
        even if Late for Dinner Studios, LLC or a Late for Dinner Studios, LLC
      ...
      <p>
        ...
        include technical, typographical, or photographic errors. Late for Dinner
        Studios, LLC does not warrant that any of the materials on its website are
        accurate, complete or current. Late for Dinner Studios, LLC may make
        changes to the materials contained on its website at any time without
        notice. However Late for Dinner Studios, LLC does not make any commitment
        to update the materials.
      </p>
      <h3>6. Links</h3>
      <p>
        Late for Dinner Studios, LLC has not reviewed all of the sites linked to
        its website and is not responsible for the contents of any such linked
        site. The inclusion of any link does not imply endorsement by Late for
        Dinner Studios, LLC of the site. Use of any such linked website is at the
        user's own risk.
      </p>
